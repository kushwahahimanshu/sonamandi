<div class="row margin-15px-top" style="background-color: #000033;">
    <div class="col-6 ">
        <!-- start page title -->
        <h5 class="alt-font text-white font-weight-600 text-uppercase padding-15px-tb no-margin">Blogs</h5>
        <!-- end page title -->
    </div>
    <div class="col-6 margin-15px-top">
        <!-- start page title -->
        <a href="{{ url('blogs') }}" class="btn btn-white btn-small margin-5px-lr" style="float: right;">View Blogs</a>
        <!-- end page title -->
    </div>
</div>
<div class="row bg-white">
    ...
    <div class="col-md-4 padding-15px-all">
        <h6 class="alt-font text-white text-uppercase padding-10px-all no-margin" style="font-size: 12px; background-color: #000033;">Latest Blogs</h6>
