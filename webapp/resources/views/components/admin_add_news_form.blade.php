<div class="col-md-8">
  ...
  <div class="box box-primary">
    <h4> Import the Excel File of News</h4>
    <form action="{{url('import-news') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <input type="file" name="file" class="form-control">
                <br>
                <button class="btn btn-success">Import News Data</button>
                <!-- <a class="btn btn-warning" href="{{url('export-directory') }}">Export Directory Data</a> -->
    </form>
    <div class="box-header with-border">
      <h3 class="box-title">Fill News Details</h3>
    </div><!-- /.box-header -->
    <!-- form start -->
    <form enctype="multipart/form-data" method="post" action="{{ url('add-news-submit') }}">
      @csrf
      <div class="box-body">
