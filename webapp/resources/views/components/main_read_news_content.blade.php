...
<div class="row padding-15px-tb" style="background-color: #000033; ">
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <!-- start page title -->
        <h1 class="alt-font text-white font-weight-600 text-uppercase" style="font-size: 32px; line-height: 35px;">{{ $news->title }}</h1>
        <!-- end page title -->
    </div>
    <div class="col-lg-12 col-sm-12 col-xs-12 display-table xs-text-left xs-margin-10px-top">
        <span class="text-white">By <a href="{{ url('news/author/'.urlencode($news->author)) }}" class="text-white">{{ $news->author }}</a></span>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<span class="text-white">{{ date_format(date_create($news->created_at), 'd F Y') }}</span>
    </div>
</div>
<div class="row no-padding">
    <img src="{{ asset($news->image) }}" class="width-100">
</div>
<div class="row padding-20px-all text-black">
    {!! $news->content !!}
</div> 
<b  style="color:black;">Total Views : {{$news->total_view}}</b> <br>
 
<div class="row padding-20px-all text-black">
    <div class="fb-like" data-href="http://www.sonamandi.com/read-news/{{ $news->id }}/{{ urlencode($news->title) }}" data-width="" data-layout="button_count" data-action="like" data-size="large" data-show-faces="true" data-share="true"></div>&nbsp;&nbsp;
    ...
    <div style="width: 15%;  border-radius: 6px;  font-size: 13px; background-color:#365899; height: 27px; display: inline-block; zoom: 1; color: white; padding-top: 3px !important; text-align: center; /* line-height: 23;">Rating:{{ $news->rating }}</div><br><br>  
    ...
    <div class="fb-comments" data-href="http://www.sonamandi.com/read-news/{{ $news->id }}/{{ urlencode($news->title) }}" data-width="100%" data-numposts="20"></div>
</div>

<div class="row" style="background-color: #000033;">
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <!-- start page title -->
        <h6 class="alt-font text-white text-uppercase text-center padding-15px-tb no-margin">More News</h6>
        <!-- end page title -->
    </div>
</div>
...
<div class="row" style="background-color: #000033;">
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <!-- start page title -->
        <h6 class="alt-font text-white text-uppercase text-center padding-15px-tb no-margin">Top News</h6>
        <!-- end page title -->
    </div>
</div>
<div class="row padding-15px-tb">
    @foreach($topnews as $r)
        <!-- start post item -->
        <div class="col-12 col-lg-4 col-md-6 margin-50px-bottom last-paragraph-no-margin sm-margin-30px-bottom wow fadeInUp">
            <div class="blog-post blog-post-style1 text-center text-md-left">
                <div class="blog-post-images overflow-hidden margin-25px-bottom md-margin-20px-bottom">
...
<div class="row" style="background-color: #000033;">
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <!-- start page title -->
        <h6 class="alt-font text-white text-uppercase text-center padding-15px-tb no-margin">More News by {{ $news->author }}</h6>
        <!-- end page title -->
    </div>
</div>
<div class="row padding-15px-tb">
    @foreach($authornews as $r)
        <!-- start post item -->
        <div class="col-12 col-lg-4 col-md-6 margin-50px-bottom last-paragraph-no-margin sm-margin-30px-bottom wow fadeInUp">
            <div class="blog-post blog-post-style1 text-center text-md-left">
                <div class="blog-post-images overflow-hidden margin-25px-bottom md-margin-20px-bottom">
