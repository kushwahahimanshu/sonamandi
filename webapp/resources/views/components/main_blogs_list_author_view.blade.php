<div class="row bg-white padding-15px-all"> 
    <div class="col-12">  
        <div class="blog-post-content d-flex align-items-center flex-wrap margin-20px-bottom padding-20px-bottom md-margin-30px-bottom md-padding-30px-bottom text-md-left" style="border-bottom: 1px solid #c4c4c4;">
            <a href="#"><img src="{{ asset($blogdata->image) }}" alt="{{ $blogdata->title }}" style="width:300px; height:250px;"></a> 
            <div  id="about" class="col-12 col-lg-7 blog-text p-0">
                <div class="content margin-20px-bottom md-no-padding-left ">
                    <p class="text-extra-dark-gray margin-5px-bottom alt-font text-extra-large font-weight-600 d-inline-block" style="font-size:17px;">Author Name:</p> <b style="padding-right:60px;">{{ $blogdata->name }}</b><br>
                    ...
                    <p style="text-align:justify; font-size:14px;">{{ $blogdata->description }}</p>
                </div>
            </div>  
        </div>
    </div>
