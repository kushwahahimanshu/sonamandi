        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              @endif 
                <a href="{{ url('delete-ad/'.$r->id) }}" class="btn btn-danger btn-sm"><i class="fa fa-trash" aria-hidden="true"></i></a>
                    <a href="{{ url('edit-home-ad/'.$r->id) }}" class="btn btn-info btn-sm" title="edit"> <i class="fa fa-edit"></i></a>
            </td>
